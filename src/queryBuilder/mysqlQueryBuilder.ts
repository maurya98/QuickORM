// src/queryBuilder/MysqlQueryBuilder.ts
...
export class MysqlQueryBuilder extends QueryBuilder {
    ...
    select(columns: string[] = []): MysqlQueryBuilder {
        this.selectColumns = columns.length > 0 ? columns : ['*'];
        return this;
    }

    from(table: string): MysqlQueryBuilder {
        this.fromTable = table;
        return this;
    }

    where(conditions: Condition[] | Condition): MysqlQueryBuilder {
        this.whereConditions = this.buildConditions(conditions);
        return this;
    }

    orderBy(columns: string[] = []): MysqlQueryBuilder {
    ...
    update(table: string): MysqlQueryBuilder {
        this.updateTable = table;
        return this;
    }

    set(columns: { [key: string]: any }): MysqlQueryBuilder {
        this.updateValues = { ...this.updateValues, ...columns };
        return this;
    }

    insertInto(table: string): MysqlQueryBuilder {
        this.insertTable = table;
        return this;
    }

    values(data: { [key: string]: any }): MysqlQueryBuilder {
        this.insertValues.push(data);
        return this;
    }

    case(conditions: { when: string; then: string }[]): MysqlQueryBuilder {
        this.caseConditions = conditions;
        return this;
    }

    deleteFrom(table: string): MysqlQueryBuilder {
        this.deleteTable = table;
        return this;
    }

    join(table: string, conditions: Condition[] | Condition): MysqlQueryBuilder {
